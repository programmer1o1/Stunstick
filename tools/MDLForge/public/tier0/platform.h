...
#define COMPILE_TIME_ASSERT(pred) static_assert((pred), "COMPILE_TIME_ASSERT failed")
#endif

#ifndef ASSERT_INVARIANT
#define ASSERT_INVARIANT(pred) static_assert((pred), "ASSERT_INVARIANT failed")
#endif
...
#if !defined(USE_DXVK) && !defined(_WIN32)
